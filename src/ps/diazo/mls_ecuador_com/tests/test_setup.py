# -*- coding: utf-8 -*-
"""Test Setup of ps.diazo.mls_ecuador_com."""
...
# local imports
from ps.diazo.mls_ecuador_com import (
    config,
    testing,
)
...
CSS = [
    '++resource++ps.diazo.mls_ecuador_com/main.css',
]

JS = [
    '++resource++ps.diazo.mls_ecuador_com/main.js',
]


class TestSetup(unittest.TestCase):
    """Validate setup process for ps.diazo.mls_ecuador_com."""

    layer = testing.PS_DIAZO_MLS_ECUADOR_COM_INTEGRATION_TESTING
    ...
    def test_addon_layer(self):
        ...
        self.assertIn('IPsDiazoMlsEcuadorComLayer', layers)
...
class UninstallTestCase(unittest.TestCase):
    ...
    def test_addon_layer_removed(self):
        ...
        layers = [l.getName() for l in registered_layers()]
        self.assertNotIn('IPsDiazoMlsEcuadorComLayer', layers)
