# -*- coding: utf-8 -*-
"""Test Setup of ps.diazo.mls-ecuador_com."""
...
# local imports
from ps.diazo.mls-ecuador_com import (
    config,
    testing,
)
...
CSS = [
    '++resource++ps.diazo.mls-ecuador_com/main.css',
]

JS = [
    '++resource++ps.diazo.mls-ecuador_com/main.js',
]


class TestSetup(unittest.TestCase):
    """Validate setup process for ps.diazo.mls-ecuador_com."""

    layer = testing.PS_DIAZO_MLS-ECUADOR_COM_INTEGRATION_TESTING
    ...
    def test_addon_layer(self):
        ...
        self.assertIn('IPsDiazoMls-EcuadorComLayer', layers)
...
class UninstallTestCase(unittest.TestCase):
    ...
    def test_addon_layer_removed(self):
        ...
        layers = [l.getName() for l in registered_layers()]
        self.assertNotIn('IPsDiazoMls-EcuadorComLayer', layers)
